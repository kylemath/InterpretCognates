...
All experiments are implemented in the open-source \textsc{InterpretCognates} toolkit, which provides a fully reproducible pipeline from raw NLLB-200 embeddings to statistical tests and figures.
