...
We further validate these findings through isotropy correction analysis, variance decomposition that disentangles orthographic from semantic contributions to convergence, and per-family offset consistency heatmaps that reveal how relational structure varies across language families.
