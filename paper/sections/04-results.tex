...
We organize our six experiments along a progression from broad distributional patterns (which concepts converge across languages?) through external validation (do these patterns match phylogenetic and colexification benchmarks?) to geometric tests of cognitive hypotheses (is conceptual structure factored from language identity, and is relational structure preserved cross-lingually?).
