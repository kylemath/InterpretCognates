...
Variance decomposition confirms that orthographic similarity explains only $R^2 = \DecompRsqOrtho{}$ of convergence variance, isotropy validation shows near-perfect rank preservation ($\rho = \IsotropySpearmanRho{}$), and per-family offset heatmaps reveal that relational structure is preserved even across typologically distant language families.
